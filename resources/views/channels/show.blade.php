        ...
        <div class="col-md-8">
            <div class="card">
                ...
                @if($channel->editable())
                    ...
                    <form id="update-channel" action={{ route('channels.update',$channel->id) }} method="POST"
                ...
                @endif
                        ...
                        @if($channel->editable())
                            <input onchange="document.getElementById('update-channel').submit()" style="display: none"
                                id="image" type="file" name="image" class="form-control">
                            <div class="form-group">
